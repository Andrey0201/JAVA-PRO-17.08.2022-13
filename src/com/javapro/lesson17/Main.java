...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    fileNavigator.add("./file/",
        new FileData("file.txt", 700, "./file/"));
    fileNavigator.add("./file/",
        new FileData("log.txt", 500, "./file/"));
    fileNavigator.add("./file/",
        new FileData("config.txt", 300, "./file/"));
    fileNavigator.add("./file/file1/",
        new FileData("myFile.txt", 500, "./file/"));
    fileNavigator.add("./file/",
        new FileData("logistic.txt", 200, "./file/"));
    fileNavigator.add("./file/newFile/",
        new FileData("logistic.txt", 450, "./file/newFile/"));
